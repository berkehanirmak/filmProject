...
import { setUserData, setUserToken } from './store/appVars';
...
function App() {
    ...
    return (
        <div className='bg-[#f9fafb] dark:bg-[#131720]'>
            {
                sessionLoaded ? <AppRoutes></AppRoutes> : 
                <div className='h-[100vh] w-full flex items-center justify-center flex-col'>
                    <img className="mb-6 object-contain" src={darkMode ? logoDark : logoWhite} alt="logo" style={{width: '280px'}}/>  
                    <div role="status">
            ...
            <Toaster
                ...
                containerClassName=""
                toastOptions={{
                    className: 'bg-white border border-gray-200 text-black dark:text-white dark:bg-gray-800 dark:border-gray-700',
                    duration: 5000,
